  ...
  return (
    <section id="categories" className="max-w-[1460px] mx-auto px-3 sm:px-6 py-6 sm:py-8">
          ...
          {categoriesData.map((category) => {
            ...
            return (
              ...
              >
                ...
                {/* Title */}
                <strong className={`block text-xs sm:text-[13px] font-black leading-tight mb-1 ${isSelected ? 'text-[#ec2f73]' : 'text-[#141219] group-hover:text-[#ec2f73]'
                  }`}>
                  {category.name}
                </strong>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3.5 items-stretch w-full">
        {/* Item 1 */}
        <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3.5 rounded-[14px] sm:rounded-[18px] bg-white border border-[#eedbe6] hover:border-[#ec2f73]/50 transition-all shadow-2xs h-full min-h-[58px] sm:min-h-[68px]">
